...
using continuation =
    std::variant<reduce_whnf_continuation, reduce_app_continuation,
                 reduce_var_continuation, reify_val_continuation,
                 reify_clo_continuation, reify_napp_continuation>;
